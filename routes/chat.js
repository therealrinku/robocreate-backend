  ...
  try {
    ...
    const finalResponse = await Promise.all(
      data.map(async (conversation) => {
        ...
        const otherParticipant = { id:2, name: 'Friend Name', image: 'https://images.unsplash.com/photo-1737559217439-a5703e9b65cb?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHw5OHx8fGVufDB8fHx8fA%3D%3D'}; // Mocked for now
